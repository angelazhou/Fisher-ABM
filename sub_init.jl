...
##! AZ: my system is throwing errors about type argument, so cast to int array
Fish_fs = convert(Array{Int}, Fish_fs)
...
global OUT        = Output(Fish_fx,Cons_xy,Fish_sx,Cons_H);
